    ...
    for column, column_profile in columns.items():
        ...
        issues.append(
            Issue(
                ...
                evidence=Evidence(
                    metric="numeric_parse_ratio",
                    observed_value=parse_ratio,
                    threshold=0.80,
                ...
                ml_impact=(
                    "Implicit numeric strings can lead to inconsistent parsing "
                ...
                reproducibility=reproducibility(
                    context,
                    {"numeric_parse_ratio_threshold": 0.80},
                ),
            )
        )
